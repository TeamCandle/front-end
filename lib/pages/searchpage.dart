    ...
    return Scaffold(
          ...
          child: Row(
            ...
            children: [
              ...
              DropdownButton<String>(
                ...
                items: <String>['소형', '중형', '대형'].map<DropdownMenuItem<String>>((String value) {
              ...
              DropdownButton<String>(
                hint: Text('케어 종류'),
                onChanged: (String? newValue) {},
                items: <String>['산책', '돌봄', '외견 케어', '놀아주기'].map<DropdownMenuItem<String>>((String value) {
                  return DropdownMenuItem<String>(
                    value: value,
                    child: Text(value),
                  );
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          if (index == dogs.length) {
            return Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  context.go("/home/match/explore/ApplicationStatus");
                },
                child: Text('신청 현황'),
              ),
            );
          ...
          return ListTile(
            onTap: () {
              context.go("/home/match/explore/exploreDetail");
            },
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            onTap: () {
              context.go("/home/match/explore/ApplicationDetail");
            },
            leading: CircleAvatar(
              backgroundImage: AssetImage('assets/images/empty_image.png'),
            ),
              ...
              children: [
                ...
                Column(
                  children:[
                    ...
                    ElevatedButton(
                      onPressed: () {
                        context.go("/home/match/explore/ExploreDetail/DogOwnerProfile");
                      },
                      child: Text('견주 프로필'),
                    ),
                  ],
...
class ApplicationDetailPage extends StatelessWidget {// exploreDetailPage랑 분리 하긴했으나 마지막 버튼 부분만 바뀜
